import type { ResourceProfileState } from '../../hooks/useResourceProfile'
import { formatNumber } from '../../hooks/useResourceProfile'

type Props = Pick<ResourceProfileState,
  | 'projectId' | 'project' | 'profile'
  | 'commercialData' | 'discounts' | 'rateCards'
  | 'showDiscountForm' | 'setShowDiscountForm' | 'discountForm' | 'setDiscountForm' | 'discountFormError'
