...
describe('CommercialTab authoritative availability presentation', () => {
  ...
  it.each([
    ...
    ['role whole-project profile', baseRow({ capacityProfile: profile('wholeProjectAllocation', { defaultPercent: 60, startWeek: 0, endWeek: 12 }) }), 'Fixed for whole project · 60%', 'Wk 0 – Wk 12', true],
